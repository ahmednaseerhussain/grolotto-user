            ...
            <Card className="bg-blue-50 border-blue-100">
                <CardContent className="p-4">
                    <p className="text-sm text-blue-800">
                        {t("Set opening and closing times for each state/draw. Players can only place bets when the draw is open. Times are in Eastern Time (ET).") ||
                            "Set opening and closing times for each state/draw. Players can only place bets when the draw is open. Times are in Eastern Time (ET)."}
                    </p>
                </CardContent>
            </Card>
